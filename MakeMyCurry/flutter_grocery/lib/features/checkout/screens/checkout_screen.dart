    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
        ...
        child: Row(children: [
          ...
          Tooltip(
            triggerMode: ResponsiveHelper.isDesktop(context) ? TooltipTriggerMode.tap : TooltipTriggerMode.tap,
            ...
            child: Container(
              ...
              child: Icon(Icons.info_outline, color: Theme.of(context).primaryColor, size: Dimensions.paddingSizeLarge),
            ),
          ),
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
              ...
              AnimatedDefaultTextStyle(
                ...
                style: poppinsRegular.copyWith(
                  ...
                  fontWeight: index == orderProvider.selectDateSlot ? FontWeight.w500 : FontWeight.normal,
                ),
                child: Text(
                  index == 0 ? getTranslated('today', context) : index == 1
              ...
              ? Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        getTranslated('no_time_slots_available', context) ?? 'No time slots available',
                        style: poppinsRegular.copyWith(
                          color: Theme.of(context).disabledColor,
                          fontSize: Dimensions.fontSizeDefault,
                        ),
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [BoxShadow(
                                ...
                                spreadRadius: orderProvider.selectTimeSlot == index ? 2 : .5, 
                                blurRadius: orderProvider.selectTimeSlot == index ? 8 : .5,
                                offset: orderProvider.selectTimeSlot == index 
                                    ? const Offset(0, 2) 
                                    : const Offset(0, 0),
                              )],
                              border: Border.all(
                                ...
                                width: orderProvider.selectTimeSlot == index ? 2 : 1,
                              ),
                            ),
                            child: Row(
                              children: [
                                AnimatedSwitcher(
                                  ...
                                  child: Icon(
                                    Icons.access_time, 
                                    key: ValueKey(orderProvider.selectTimeSlot == index),
                                    color: orderProvider.selectTimeSlot == index 
                                        ? Theme.of(context).cardColor 
                                        : Theme.of(context).primaryColor, 
                                    size: 20
                                ...
                                AnimatedDefaultTextStyle(
                                  ...
                                  style: poppinsRegular.copyWith(
                                    ...
                                    color: orderProvider.selectTimeSlot == index 
                                        ? Theme.of(context).cardColor 
                                        : Theme.of(context).textTheme.bodyLarge?.color,
                                    fontWeight: orderProvider.selectTimeSlot == index 
                                        ? FontWeight.w500 
                                        : FontWeight.normal,
                                  ),
                                  child: Text(
